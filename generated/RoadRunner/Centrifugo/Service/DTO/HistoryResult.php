...
class HistoryResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \RoadRunner\Centrifugo\Service\DTO\Publication[]|\Google\Protobuf\Internal\RepeatedField $publications
     *     @type string $epoch
    ...
    /**
     * Generated from protobuf field <code>repeated .centrifugal.centrifugo.api.Publication publications = 1;</code>
     * @param \RoadRunner\Centrifugo\Service\DTO\Publication[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPublications($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \RoadRunner\Centrifugo\Service\DTO\Publication::class);
